...
success:close — пользователь закрыл сообщение.
...
card:addToCart — товар добавлен в корзину.
...
basket:order — пользователь нажал «Оформить заказ».
...
card:select — пользователь выбрал карточку.
...
card:remove — товар удалён из корзины.
